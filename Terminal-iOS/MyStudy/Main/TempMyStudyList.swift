...
class TempMyStudyList {
    static var List: [MyStudy] = [
        MyStudy(id: 0, title: "강남역 스터디", location: "강남역 야야", image: "swiftmain"),
        MyStudy(id: 9, title: "홍대역 잉겔스", location: "서초구", image: "android"),
        MyStudy(id: 8, title: "스위프트 스터디", location: "배고프구", image: "frontend"),
        MyStudy(id: 7, title: "홍대 나의봄날", location: "배구농구 ㅋㅋ", image: "tensorflow"),
        MyStudy(id: 4, title: "사당역 더포도", location: "낄낄미튼미튼", image: "node"),
