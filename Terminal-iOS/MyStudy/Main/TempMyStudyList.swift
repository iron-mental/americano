...
class TempMyStudyList {
    static var List: [MyStudy] = [
        ...
        MyStudy(id: 1, title: "홍대역 잉겔스", location: "끝이 아니군", image: "android"),
        MyStudy(id: 3, title: "스위프트 스터디", location: "저녁에 햄버거", image: "frontend"),
        MyStudy(id: 5, title: "홍대 나의봄날", location: "먹기로 했었는데", image: "tensorflow"),
        MyStudy(id: 7, title: "사당역 더포도", location: "배가 좀 많이 안좋네", image: "node"),
        ...
        MyStudy(id: 0, title: "당신은 날 울리는", location: "살아서 돌아오길", image: "android"),
        MyStudy(id: 6, title: "땡벌 땡벌", location: "쨔스", image: "android"),
        MyStudy(id: 8, title: "오예 끝", location: "오우오우오우", image: "node")
    ]
}
